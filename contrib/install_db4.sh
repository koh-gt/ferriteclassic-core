...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the ferriteclassic repository."
  exit 1
fi
...
echo 'When compiling ferriteclassicd, run `./configure` in the following way:'
echo
