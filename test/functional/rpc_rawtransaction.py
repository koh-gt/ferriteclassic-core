...
class RawTransactionsTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-5, "Invalid FerriteClassic address", self.nodes[0].createrawtransaction, [], {'foo': 0})
        ...
        if not self.options.descriptors:
            ...
            self.sync_all()
            assert_equal(self.nodes[2].getbalance(), bal+Decimal('1.20000000')) #node2 has both keys of the 2of2 ms addr., tx should affecct the balance
