...
"""Verify that starting ferriteclassic with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start ferriteclassic with -h for help text")
        ...
        self.log.info("Start ferriteclassic with -version for version information")
        ...
        self.log.info("Start ferriteclassicd with -fakearg to make sure it does not start")
