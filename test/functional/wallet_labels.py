...
class WalletLabelsTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        BECH32_VALID = {
            '✔️_VER15_PROG40': 'rfecc10qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqevpw9x',
            '✔️_VER16_PROG03': 'rfecc1sqqqqqap5g4h',
            '✔️_VER16_PROB02': 'rfecc1sqqqqfsjxnh',
        }
        BECH32_INVALID = {
        ...
        for l in BECH32_INVALID:
            ...
            assert_raises_rpc_error(
                -5,
                "Address is not valid" if self.options.descriptors else "Invalid FerriteClassic address or script",
