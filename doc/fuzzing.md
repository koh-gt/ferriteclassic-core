# Fuzzing FerriteClassic Core using libFuzzer

## Quickstart guide

To quickly get started fuzzing FerriteClassic Core using [libFuzzer](https://llvm.org/docs/LibFuzzer.html):

```sh
$ git clone https://github.com/ferriteclassic-project/ferriteclassic
$ cd ferriteclassic/
$ ./autogen.sh
...
[`process_message`](https://github.com/ferriteclassic-project/ferriteclassic/blob/master/src/test/fuzz/process_message.cpp) is a fuzzing harness for the [`ProcessMessage(...)` function (`net_processing`)](https://github.com/ferriteclassic-project/ferriteclassic/blob/master/src/net_processing.cpp). The available fuzzing harnesses are found in [`src/test/fuzz/`](https://github.com/ferriteclassic-project/ferriteclassic/tree/master/src/test/fuzz).
...
Every single pull request submitted against the FerriteClassic Core repo is automatically tested against all inputs in the [`bitcoin-core/qa-assets`](https://github.com/bitcoin-core/qa-assets) repo. Contributing new coverage increasing inputs is an easy way to help make FerriteClassic Core more robust.
...
with certain assembly code from FerriteClassic Core's code. See [developer notes on sanitizers](https://github.com/ferriteclassic-project/ferriteclassic/blob/master/doc/developer-notes.md#sanitizers)
...
# Fuzzing FerriteClassic Core using american fuzzy lop (`afl-fuzz`)

## Quickstart guide

To quickly get started fuzzing FerriteClassic Core using [`afl-fuzz`](https://github.com/google/afl):
